<template>
  <section class="px-4 py-6 max-w-4xl mx-auto mb-16">
    ...
    <ul class="list-disc list-inside text-lg sm:text-xl text-gray-500 mb-6">
      <li><strong class="text-[#A97A13]">Frontend:</strong> HTML, CSS, JavaScript, React, Vue.js, Tailwind CSS</li>
      <li><strong class="text-[#A97A13]">Backend:</strong> Node.js, Express, MongoDB, PHP, MySQL</li>
      <li><strong class="text-[#A97A13]">Tools:</strong> Git, GitHub, Postman, Canva</li>
    </ul>
